...
<html>
  ...
  <form action="descarga.php" method="post">
			...
			<div class="form-group">
				<input name="btnForget" class="btn btn-lg btn-primary btn-block btnForget" value="Seleccionar" type="submit" style="background-color: #dc3545; color: #fff; border: none; padding: 10px 20px; border-radius: 5px; box-shadow: 2px 2px 5px rgba(0,0,0,0.3); transition: all 0.3s ease; cursor: pointer;">
			</div>
		  </form>
	</div>
  </body>
